...
import { Ban, Download, Search, TriangleAlert } from "lucide-react";
    ...
    return allUsers.filter((user) => {
      ...
      const matchesGlobal = deferredGlobalFilter
        ? Object.values(user)
            .join(" ")
            .toLowerCase()
            .includes(deferredGlobalFilter.toLocaleLowerCase())
        : true;
          ...
          <div className="bg-[#1e293b] rounded-2xl shadow-lg w-[90%] max-w-md p-6 relative">
            ...
            <div className="mb-6">
              <p className="text-gray-300 leading-6">
                <span className="text-yellow-400 font-semibold">
                  <TriangleAlert size={18} /> Important:{" "}
                </span>
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-sm text-white font-semibold"
              >
                Cancel
              </button>
              <button
                onClick={() => banUserMutation.mutate(selectedUser.id)}
                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-sm text-white font-semibold"
              >
