...
import GeoGraphicalMap from '../../shared/components/charts/geo-graphical-map';
        ...
        <div className='w-[65%]'>
          <div className='rounded-2xl shadow-xl'>
            <h2 className='text-white text-xl font-semibold'>
              Revenue
              <span className='block text-sm text-slate-400 font-normal'>Last 6 month performance</span>
            </h2>
            <SalesChart  />
          </div>
        </div>
