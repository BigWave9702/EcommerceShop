...
const page = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto px-4 py-10'>
      ...
      <div className='my-4'>
        <div className='flex items-center justify-between text-xs font-medium text-gray-500 mb-2'>
          {[
            ...
            const current=
              step.toLowerCase()===(order.deliveryStatus||"processing").toLowerCase();
            ...
            const passed=
              ...
              [
                ...
                (s) =>
                  s.toLowerCase()===(order.deliveryStatus||"processing").toLowerCase()
              );
      ...
      {/* Order Items */}
      <div>
        <h2 className='tex-lg font-semibold text-gray-700 mb-4'>
          Order Items
        </h2>
