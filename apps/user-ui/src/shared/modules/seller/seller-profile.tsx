...
import { images, shops } from  "@prisma/client"
...
import {Calendar, Clock, Globe, Heart, MapPin, Star, User, XIcon, YoutubeIcon} from 'lucide-react';
...
type ShopWithAvatar = shops & {
  avatar?: images | string | null;
};
        ...
        <div className='bg-gray-200 p-6 rounded-lg shadow-lg flex-1'>
          <div className='flex flex-col md:flex-row gap-6 items-center md:items-start'>
            <div className='text-sm text-gray-600'>
              {followersCount} followers{isFollowing ? " - Following" : ""}
            </div>
            <div className='relative w-[1000px] h-[1000px] rounded-full border-4 border-slate-300 overflow-hidden'>
              <Image
                src={getImageUrl(shop?.avatar, DEFAULT_SHOP_IMAGE)}
                alt='Seller Avatar'
                layout='fill'
                objectFit='cover'
              />
            ...
            <div className='flex-1 w-full'>
              ...
              <div className='flex items-center gap-4 mt-2'>
                <div className='flex items-center text-blue-400 gap-1'>
                  ...
                  <span>{shop?.ratings || "No Rating"}</span>
                </div>
